package com.anshtya.data.paging.movies
...
internal class NowPlayingMoviesPagingSource @Inject constructor(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ContentItem> {
        ...
        return try {
            val response = tmdbApi.getMovieLists(
                category = MovieListCategory.NOW_PLAYING.categoryName,
                page = pageNumber
            )
            LoadResult.Page(
